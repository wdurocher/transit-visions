...
export const transits: Transit[] = [
  {
    ...
    short:
      "The Moon slips through Libra in about two-and-a-half days, so this is a passing mood rather than a life chapter. Libra wants harmony, beauty, and the other person — for a couple of days you may find yourself smoothing edges, choosing nicer surroundings, or simply needing company more than usual.",
    long:
  ...
  },
  {
    ...
    short:
      "The Sun spends a full month in each sidereal sign. In Taurus the pace slows and the world turns tangible — money, the body, food, and what you actually own become harder to ignore. This is a month for finishing, pricing, and committing to what already works.",
    long:
  ...
  },
  {
    ...
    short:
      "Venus changes sign every few weeks, and in Gemini she gets talkative. Love and beauty start to run on conversation, curiosity, and wit rather than depth. This is a window for flirty messages, clever design, and letting your social life branch out in several directions at once.",
    long:
  ...
  },
  {
    ...
    short:
      "Mars is at home in Aries — cardinal fire meets raw will — so this transit is like getting the starter's gun back. About six weeks of unusually direct energy: you start faster, push harder, and say what you mean before you have time to soften it.",
    long:
  ...
  },
  {
    ...
    short:
      "Jupiter stays in a sign for roughly a year, and in Gemini it magnifies communication, learning, and reach. This chapter is almost over, so the coming weeks are the last call to publish, teach, pitch, or grow the network you've been meaning to build.",
    long:
  ...
  },
  {
    ...
    short:
      "Neptune is just beginning a 14-year stay in its home sign Pisces. That is slow enough to be a cultural tide, not a personal weekend. Pisces dissolves boundaries, so over the coming years intuition, art, longing, and the urge to escape all get louder — for everyone.",
    long:
  ...
  },
  {
    ...
    short:
      "Uranus takes about seven years per sign, and the Taurus chapter is nearly done. Its job has been to shake money, food, ownership, and the body — the slow, stable things — until whatever was pretending to be safe revealed itself. The final months are for sorting what actually belongs in your life.",
    long:
  ...
  },
  {
    ...
    short:
      "Pluto crawls so slowly that its retrograde lasts five months and covers only a few degrees. In Capricorn the review is institutional — your place inside systems, hierarchies, and old rules. Think of it as an internal audit, not a public explosion.",
    long:
